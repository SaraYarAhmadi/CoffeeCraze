          ...
          <div className="flex flex-col justify-between lg:flex-row gap-5 lg:items-center">
            ...
            <div className="flex flex-col text-justify justify-start gap-6 lg:w-2/4 md:mr-8">
              ...
              <p className="text-gray-700">
                دو گونه گیاهی مطرح در دنیای قهوه که همواره در تقابل با هم بوده
                اند Robusta و Arabica در این ترکیب کنار هم قرار گرفته اند با این
                تفاوت که اکثریت آنرا بر خلاف دیگر محصولات برشته کاری ” قهوه ست ”
                دانه های Robusta تشکیل می دهند . برای افرادی که لذت نوشیدن قهوه
                را در میزان کافئین آن جستجو می کنند . قهوه ای ساده که اسیدیته
                پایینی دارد و در مقابل تن واری و کافئین و تلخی بالاتری نسبت به
                دیگر محصولات “قهوه ست ” دارد .
              </p>
