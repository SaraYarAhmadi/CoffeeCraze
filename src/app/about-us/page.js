              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col justify-center gap-6 sm:pt-0">
                  ...
                  <p className="text-sm text-gray-500 tracking-wide leading-5">
                    ...
                    و... فعالیت می کند. مجموعه ما از سال ۱۳۸۴ تا به امروز در
                    زمینه روست و ترکیب قهوه های مخصوص و ممتاز و همچنین ارائه
                    برند های معتبر در زمینه قهوه برند و کپسول قهوه لوازم و
                    تجهیزات حرفه ای و خانگی + انواع کافی میکس مشغول می باشد.
                  </p>
                  <div>
                    <Link
                      href="/gallery"
