      ...
      <div className="xl:col-span-2 bg-white dark:bg-gray-800 p-4.5 rounded-2xl w-[90%] mx-auto">
        <form id="edit-account-info" className="p-3.5 pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-6">
            <div>
              <label for="username" className="text-zinc-700 text-start mb-1">
                نام کاربری
              </label>
              <input
                type="text"
            ...
            <div>
              <label for="phone" className="text-zinc-700 text-start mb-1">
                شماره موبایل
              </label>
              <input
                type="number"
            ...
            <div>
              <label for="first_name" className="text-zinc-700 text-start">
                ایمیل
              </label>
              <div className="py-2">
                <input
          ...
          <div className="grid grid-cols-2 gap-x-5 gap-y-6 my-10">
            <div>
              <label for="email" className="text-zinc-700 text-start">
                پسورد
              </label>
              <div className="py-2">
                <input
